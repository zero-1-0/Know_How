      ...
      <div id="MainMenu">
        <div class="list-group panel">
          ...
          <div class="collapse" id="demo1">
            ...
            <?php 
                        $result=mysqli_query($cn,"SELECT * FROM examinfo WHERE sub_id LIKE 'cs%' AND e_status=1 ");
                        $i=1;
          ...
          <div class="collapse" id="demo2">
            ...
            <?php 
                        $result=mysqli_query($cn,"SELECT * FROM examinfo WHERE sub_id LIKE 'ce%' AND e_status=1 ");
                        $i=1;
                        while($row = mysqli_fetch_array($result)) {
                          echo '<a href="exm_1.php?set=cs'.$i.'" class="list-group-item">'.$row['test_name'].'</a>';
                          $i++;
          ...
          <div class="collapse" id="demo3">
            ...
            <?php 
                        $result=mysqli_query($cn,"SELECT * FROM examinfo WHERE sub_id LIKE 'ec%' AND e_status=1 ");
                        $i=1;
                        while($row = mysqli_fetch_array($result)) {
                          echo '<a href="exm_1.php?set=cs'.$i.'" class="list-group-item">'.$row['test_name'].'</a>';
                          $i++;
          ...
          <div class="collapse" id="demo4">
            ...
            <?php 
                        $result=mysqli_query($cn,"SELECT * FROM examinfo WHERE sub_id LIKE 'ee%' AND e_status=1 ");
                        $i=1;
                        while($row = mysqli_fetch_array($result)) {
                          echo '<a href="exm_1.php?set=cs'.$i.'" class="list-group-item">'.$row['test_name'].'</a>';
                          $i++;
          ...
          <div class="collapse" id="demo5">
            ...
            <?php 
                       $result=mysqli_query($cn,"SELECT * FROM examinfo WHERE sub_id LIKE 'it%' AND e_status=1 ");
                          $i=1;
                        while($row = mysqli_fetch_array($result)) {
                          echo '<a href="exm_1.php?set=cs'.$i.'" class="list-group-item">'.$row['test_name'].'</a>';
                          $i++;
          ...
          <div class="collapse" id="demo6">
            ...
            <?php 
                        $result=mysqli_query($cn,"SELECT * FROM examinfo WHERE sub_id LIKE 'me%' AND e_status=1 ");
                       $i=1;
                        while($row = mysqli_fetch_array($result)) {
                          echo '<a href="exm_1.php?set=cs'.$i.'" class="list-group-item">'.$row['test_name'].'</a>';
                          $i++;
